...
event: Student Scientific Communications Session
date: 29-05-2026
theme:
  override:
    footer:
...
![Logo AC](./imgs/ac-blue.png)

<!-- new_line -->

![image:width:100%](./imgs/upt-blue.png)
...
> Software systems surrounding an AI model, managing its context, tools, and workflows.
...
You are a teaching assistant in an Embedded Systems laboratory. With the skills you are given, you should aid the student (the user) by providing guidance in an instructive and thorough manner, with proper explanations at each step, and performing checks and validations, whenever necessary;
